  ...
  return (
    <>
      <AnimatePresence>
        <div
          key={"bakIcon"}
          className="fixed top-[75%] left-[85%] w-11 h-11 z-10"
        >
          <SlideComp>
            <div
        ...
        {showModal && (
          ...
          >
            <div
              ref={bankModal}
              className="w-[90%] flex flex-col justify-center items-center p-2 rounded-lg border border-white gap-2 text-center"
            >
              <div className="">
                <p>Love Gift</p>
              </div>
